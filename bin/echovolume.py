...
class EchoSurvey(dict):
    ...
    def __init__(self, filename):
        ...
        try:
            ...
            output_error(exc, msg='Error in echovolume.EchoSurvey.__ini__')
...
def main():
    ...
    Input is pairs of matching primer layout and primer survey files, plus the destination file for primer volumes
    """
    try:
        ...
        output_error(exc, msg='Error in echovolume main code body')
